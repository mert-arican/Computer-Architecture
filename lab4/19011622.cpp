...
extern "C" void convolve(unsigned, unsigned, unsigned, unsigned, unsigned, unsigned*, unsigned*, unsigned*);  // Declare the assembly function
...
int main() {
    ...
    convolve(output_rows, output_cols, k, k, m, kernel, matrix, output);    
